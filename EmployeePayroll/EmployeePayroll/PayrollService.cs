                ...
                using (connection)
                {
                    ...
                    if(dr.HasRows)
                    {
                        while(dr.Read())
                        {
                            ...
                            emp.EmployeeName = dr[1] != null ? dr.GetString(0) : "Akhila";
                            emp.Address = dr[2] != null ? dr.GetString(0) : "Hyd";
                            emp.Phonenumber = dr[3] != null ? dr.GetString(0) : "gh";
                            emp.Gender = dr[4] != null ? dr.GetString(0) : "xyz";
                            emp.Deduction = dr[5] != null ? dr.GetDouble(0) : 1;
                            ...
                            emp.Salary = dr[12] != null ? dr.GetInt32(0) : 0;
